...
/*
 ...
 컨테이너: component 의 후손중에서 Container 라는 클래스가 있는데
	...
	윈도우 같은 것을 말하면 윈도우, 프레임, 패널 ,다이얼로그 박스들이 있다.
	(다른 컴포넌트를 담을 수 있는 컴포넌트)
 레이아웃 : 컨테이너에 컴포넌트를 붙을 떄 어떤 식으로 배치하는 가가 중요한대
 	이것을 레이아웃이라고 한다.
 이벤트: 사용자로 부터 입력이 일어나고 그에 따라 반응하도록 설계하는 모든 기능을 말한다.
 */
public class FrameDemo {
	...
	//동적으로 변환된다. 즉, 14인치 화면이든 6인치 스마트폰이든
	//가운데 쯤에 프레임이 보여지게 된다.
