...
public class AddElementDemo {
	public static void main(String[] args) {
		...
		if(avengers.contains(thor)){
			...
			System.out.println("토르는" + idx+1 + "번째 있습니다.");
		}else{
			System.out.println("토르는 없습니다.");
		}
		/*
		 첫번쨰 요소를 삭제 removeElementAt()
		 */
		avengers.removeElement(0);
		
		System.out.println("삭제 후 요소를 인댁스 변화");
		...
		/*
		 결과를 보면 요소에 할당된 인덱가 변한 것을 알 수 있는데,
		 이것은 백터가 요소에 할당하는 인덱스가 동적으로 이뤄지고
		 있음을 나타냅니다.
		 */
	}
}
